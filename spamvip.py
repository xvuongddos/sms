...
:::..:::::..:::::..::..::::..:::......:::..:::::..::::::::::::......:::..:::::::::..:::::..::..:::::..::                         
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"  ENTER PHONE SPAM: "))
            if self.phone != '0382778481':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0382778481':
                print(self.format_print("!", "LÀM ƠN ĐỪNG SPAM SỐ ĐIỆN THOẠI HÙNG"))
            time.sleep(3)
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('*', 'tool của Hùng:)'))
